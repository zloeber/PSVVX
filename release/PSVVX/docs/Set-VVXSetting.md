...
```
Set-VVXSetting [-Device] <String> -Setting <String> -Value <String> [-Protocol <String>] [-Port <Int32>]
...
Set-VVXSetting -Credential $cred -Protocol 'https' -Port 443 -Device '10.0.29.20' -IgnoreSSLCertificate -ErrorAction:Ignore -Value 1
