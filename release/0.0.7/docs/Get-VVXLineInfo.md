...
```
Get-VVXLineInfo [-Device] <String> [-Protocol <String>] [-Port <Int32>] [-RetryCount <Int32>]
...
Get-LineInfo -Credential $cred -Protocol 'https' -Port 443 -Device '10.0.29.20' -IgnoreSSLCertificate -ErrorAction:Ignore
