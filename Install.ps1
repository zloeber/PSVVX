# Run this in an administrative PowerShell prompt to install the PSVVX PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/zloeber/psvvx/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'PSVVX'
$DownloadURL = 'https://github.com/zloeber/psvvx/raw/master/release/PSVVX-current.zip'
